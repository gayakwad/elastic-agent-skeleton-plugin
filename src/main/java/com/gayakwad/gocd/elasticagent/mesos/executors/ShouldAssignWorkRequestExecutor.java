...
package com.gayakwad.gocd.elasticagent.mesos.executors;

import com.gayakwad.gocd.elasticagent.mesos.AgentInstances;
import com.gayakwad.gocd.elasticagent.mesos.MesosInstance;
import com.gayakwad.gocd.elasticagent.mesos.PluginRequest;
import com.gayakwad.gocd.elasticagent.mesos.RequestExecutor;
import com.gayakwad.gocd.elasticagent.mesos.requests.ShouldAssignWorkRequest;
...
public class ShouldAssignWorkRequestExecutor implements RequestExecutor {
    private final AgentInstances<MesosInstance> agentInstances;
    private final PluginRequest pluginRequest;
    private final ShouldAssignWorkRequest request;

    public ShouldAssignWorkRequestExecutor(ShouldAssignWorkRequest request, AgentInstances<MesosInstance> agentInstances, PluginRequest pluginRequest) {
